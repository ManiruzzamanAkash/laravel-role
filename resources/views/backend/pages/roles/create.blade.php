        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                ...
                <form action="{{ route('admin.roles.store') }}" method="POST">
                    ...
                    <div>
                        <label for="permissions" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                            Permissions
                        </label>
                        <div class="mb-2">
                        ...
                        <div class="flex flex-wrap items-start gap-3 mb-4">
                            <div class="basis-1/3">
                                <label for="{{ $i }}Management" class="capitalize flex items-center text-sm font-medium text-gray-700 cursor-pointer select-none dark:text-gray-400" title="Toggle all permissions in this group" onclick="checkPermissionByGroup('role-{{ $i }}-management-checkbox', this)">
