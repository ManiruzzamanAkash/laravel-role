            ...
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    @if ($usr->can('permission.create') || $usr->can('permission.view') ||  $usr->can('permission.edit') ||  $usr->can('permission.delete'))
                        <li>
                            <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-lock"></i><span>
                        Permissions
                    </span></a>
                            <ul class="collapse {{ Route::is('admin.permissions.create') || Route::is('admin.permissions.index') || Route::is('admin.permissions.edit') || Route::is('admin.permissions.show') ? 'in' : '' }}">
                                ...
                                @if ($usr->can('permission.create'))
                                    <li class="{{ Route::is('admin.permissions.create')  ? 'active' : '' }}"><a href="{{ route('admin.permissions.create') }}">Create Permission</a></li>
                                @endif
                            </ul>
                        </li>
                    @endif
